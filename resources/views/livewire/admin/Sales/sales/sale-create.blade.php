    ...
    <x-w-card title="Registro de Comprobante">
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <x-w-select label="Cliente" placeholder="Seleccione un cliente" wire:model="customer_id"
                ...
                <x-w-select label="Cotización" placeholder="Seleccione un cotización" wire:model.live="quote_id"
                    :async-data="['api' => route('api.quotes.index'), 'method' => 'POST']" option-label="name" option-value="id" />
            </div>
