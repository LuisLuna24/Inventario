    ...
    <x-w-card title="Registro de Comprobante">
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                <x-w-native-select label="Tipo de movimiento" wire:model.live="type">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <x-w-select label="Almacen" placeholder="Seleccione un almacen" wire:model="warehouse_id"
                    :async-data="['api' => route('api.warehouses.index'), 'method' => 'POST']" option-label="name" option-value="id" :disabled="count($products)" />

                <x-w-select label="Razón del movimiento" placeholder="Seleccione una razón" wire:model="reason_id"
                    :async-data="['api' => route('api.reasons.index'), 'method' => 'POST', 'params' => ['type' => $type]]" option-label="name" option-value="id" />
            </div>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th class="px-4 py-3 w-40">Precio costo</th>
