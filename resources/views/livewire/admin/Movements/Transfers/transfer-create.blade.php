    ...
    <x-w-card title="Registro de Comprobante">
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <x-w-select label="Almacen origen" placeholder="Seleccione un almacen"
                    wire:model.live="origin_warehouse_id" :async-data="['api' => route('api.warehouses.index'), 'method' => 'POST']" option-label="name" option-value="id" :disabled="count($products)" />

                <x-w-select label="Almacen destino" placeholder="Seleccione un almacen"
                    wire:model="destination_warehouse_id" :async-data="[
